...
namespace PivotApp4
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        private void msg_Click(object sender, RoutedEventArgs e)
        {
            ...
            smsComposeTask.To = content;
            smsComposeTask.Body = "Help Help Help!!!!!  I am in a great danger.Please help me out. my current location is latitude:"+latitudelongitude.Latitude+"  longitude:"+latitudelongitude.Longitude;
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                mailTask.Body = "My name is " + compboxname.Text + " my contact no is " + contactno.Text + "i am giving you the description of the incident i am a victim of " + desc.Text + "    please take further important actions";
            }
            if (rad2.IsChecked==true)
            {
                mailTask.Body = "My name is " + compboxname.Text + " my contact no is " + contactno.Text + "i am giving you the description of the incident i am a eye witness of " + desc.Text + "    please take further important actions";
            }
                mailTask.Subject = "complaint about an incident";
            //mailTask.Body = "";
            mailTask.Show();
        }
